...
/**
 * This is the FollowerConstants class. It ho3lds many constants and parameters for various parts of
...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "titan";
    public static String leftRearMotorName = "oreo";
    public static String rightFrontMotorName = "daisy";
    public static String rightRearMotorName = "maggie";
